...
function TheEndHoodieCard () {
    return (
    <StyledCard>
        <div className="clothingcard">
            <div className="pictureframe">
                <img className="garment" src={The_End_Hoodie_0} alt="" style={{ width: 280, height: 360 }}/>
            </div>
            <div className="infoframe">
                <h2 className="name">The End Hoodie</h2>
                 <div>
...
export default TheEndHoodieCard
