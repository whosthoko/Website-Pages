...
function NineteenThirtySweatshirtCard () {
    return (
    <StyledCard>
        <div className="clothingcard">
            <div className="pictureframe">
                <img className="garment" src={a1930_Sweatshirt_0} alt="" style={{ width: 280, height: 360 }}/>
            </div>
            <div className="infoframe">
                <h2 className="name">1930 Sweatshirt</h2>
                 <div>
...
export default NineteenThirtySweatshirtCard
