...
function MovieHoodieCard () {
    return (
    <StyledCard>
        <div className="clothingcard">
            <div className="pictureframe">
                <img className="garment" src={Movie_Hoodie_0} alt="" style={{ width: 280, height: 360 }}/>
            </div>
            <div className="infoframe">
                <h2 className="name">Movie Hoodie</h2>
                 <div>
...
export default MovieHoodieCard