...
function GradientPantsPurpleOrangeCard () {
    return (
    <StyledCard>
        <div className="clothingcard">
            <div className="pictureframe">
                <img className="garment" src={Gradient_Pants_Purple_Orange_0} alt="" style={{ width: 280, height: 360 }}/>
            </div>
            <div className="infoframe">
                <h2 className="name">Gradient Pants</h2>
                 <div>
                    <h4 className="colorheader">Color</h4>
                    <h4 className="color">Purple/Orange</h4>
...
export default GradientPantsPurpleOrangeCard