...
function GradientPantsBlackPurpleOrangeCard () {
    return (
    <StyledCard>
        <div className="clothingcard">
            <div className="pictureframe">
                <img className="garment" src={Gradient_Pants_Black_Purple_Orange_0} alt="" style={{ width: 280, height: 360 }}/>
            </div>
...
export default GradientPantsBlackPurpleOrangeCard
