...
function GradientPantsBlueWhiteCard () {
    return (
    <StyledCard>
        <div className="clothingcard">
            <div className="pictureframe">
                <img className="garment" src={Gradient_Pants_Blue_White_0} alt="" style={{ width: 280, height: 360 }}/>
            </div>
            <div className="infoframe">
                <h2 className="name">Gradient Pants</h2>
                 <div>
                    <h4 className="colorheader">Color</h4>
                    <h4 className="color">Blue/White</h4>
...
export default GradientPantsBlueWhiteCard
