...
function GreeceTshirtCard () {
    return (
    <StyledCard>
        <div className="clothingcard">
            <div className="pictureframe">
                <img className="garment" src={Greece_T_Shirt_0} alt="" style={{ width: 280, height: 360 }}/>
            </div>
            <div className="infoframe">
                <h2 className="name">Greece T-Shirt</h2>
                 <div>
...
export default GreeceTshirtCard